    ...
    <>
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-5 p-4 sm:p-10">
          <InProgress className='w-full md:w-1/2 lg:w-1/2' />
          <Resolved className='w-full md:w-1/2 lg:w-1/2' />
        </div>

        <div className="pb-5 pt-5 flex flex-col lg:flex-row justify-between gap-4 lg:gap-0">
          <TicketCards className='w-full md:w-3/4 lg:w-3/4' setTaskHistory={setTaskHistory} />   
          <div className='w-full md:w-1/4 lg:w-1/4'>
            <TaskStatus  taskHistory={taskHistory} setTaskHistory={setTaskHistory} setResolvedTasks={setResolvedTasks} />
